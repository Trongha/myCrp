...
if (__name__ == "__main__"):
	...
	formatSave = ".png"
	epsilon = 0.009
	pathFolder = "1301_smoothListGaussian/"
	...
	for degree in [2, 3, 5, 7, 9]:
		...
		allSmoothingTrainSet = [myCrpFunctions.smoothListGaussian(trainSet, degree = degree) for trainSet in allTrainSet]
		smoothingTestSet = myCrpFunctions.smoothListGaussian(testSet, degree = degree)
